...
Next work goes on a **new branch** off the attempt you want to beat. Do not rewrite v0, v1, v1.1, or v1.2 media.
...
Raising the 320×180 analysis raster (apples-to-apples vs the 640×360 source) is the next branch after v2, not this one. Clip-wide NeRV is later still.
...
On `attempt/v2-residual-nets`, `media/stats-v2.json` holds the probe numbers. The live lab keeps v0, v1, v1.1, and v1.2 reconstructs so you can A/B without checking out a branch.
