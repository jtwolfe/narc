...
Next work goes on a **new branch** off the attempt you want to beat. Do not rewrite v0 or v1 media.
...
On `attempt/v1.1-mc-correct`, `media/stats-v1.1.json` holds the probe numbers. The live lab keeps v0, v1, and v1.1 reconstructs so you can A/B without checking out a branch.
